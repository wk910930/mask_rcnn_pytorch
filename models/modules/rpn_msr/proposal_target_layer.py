...
def proposal_target_layer(rpn_rois, gt_boxes, gt_ishard, dontcare_areas, _num_classes):
    ...
    bbox_targets: (1 x H x W x A, Kx4) [dx1, dy1, dx2, dy2]
    ...
    # TODO: zeros means all are from the first image which will be modified
    ...
    # Sanity check: single batch only TODO: allow more images at a time
